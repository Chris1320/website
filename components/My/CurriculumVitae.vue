            ...
            <div class="pt-15 pl-15 pr-15">
                ...
                <section class="my-6 px-4">
                    <div class="flex items-center mb-4">
                        <Icon name="mdi:school" class="inline-block w-8 h-8 mr-2" size="32" />
                ...
                <section class="my-6 px-4">
                    <div class="flex items-center mb-4">
                        <Icon name="mdi:briefcase" class="inline-block w-8 h-8 mr-2" size="32" />
                ...
                <section class="my-6 px-4">
                    <div class="flex items-center mb-4">
                        <Icon name="mdi:certificate" class="inline-block w-8 h-8 mr-2" size="32" />
                ...
                <section class="my-6 px-4">
                    <div class="flex items-center mb-4">
                        <Icon name="mdi:star-circle" class="inline-block w-8 h-8 mr-2" size="32" />
